...
NEON_SCENE_CAMERA_SPEC = CameraSpec(
    ...
    vendor_id=0x0BDA,
    product_id=0x3036,
    width=int(os.getenv("NEON_SCENE_UVC_WIDTH", "2048")),
    height=int(os.getenv("NEON_SCENE_UVC_HEIGHT", "1536")),
    fps=int(os.getenv("NEON_SCENE_UVC_FPS", "15")),
    bandwidth_factor=float(os.getenv("NEON_SCENE_UVC_BW_FACTOR", "0.6")),
)
